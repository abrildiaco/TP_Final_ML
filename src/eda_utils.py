...
def plot_missing_values(data, top_n=None, title="Valores faltantes por columna"):
    ...
    Returns:
        pd.DataFrame: table with missing counts and percentages
    """
    ...
    bars = ax.barh(missing_table["column"], missing_table["missing_percentage"], color=FORMAL_COLORS["blue"])
    ax.invert_yaxis()
